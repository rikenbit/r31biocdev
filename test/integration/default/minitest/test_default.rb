...
describe 'check Bioconductor version' do
  it "check Bioconductor version" do
    ...
    # develop
    assert system('grep "Bioconductor version 3.1 (BiocInstaller 1.17.3)" showBioconductorVersion.Rout'), 'Bioconductor version is not expected version. maybe Bioconductor package is updated'
    # stable
